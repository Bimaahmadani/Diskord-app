...
export function CloseIcon({ className ='h-6 w-7 text-gray-500' }: IconProps): JSX.Element {
    return (
        <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
...
export function GIF({ className = 'w-full h-full' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function Emoji({ className = 'w-full h-full' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function Thread({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function Apps({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
...
export function CloseMark({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
export function Send({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
...
export function Phone({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
 <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
